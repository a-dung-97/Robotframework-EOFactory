...
#    type input
    ...
    click element  //*[@id="ardtools_visual_image"]/div/div/div[1]
    input text  id:ardtools_visual_image_imageSelector_searchInput   visual_image
    click element  id:visual_image
    ...
    input text  id:ardtools_visual_min  3
    input text  id:ardtools_visual_max  90
