...
#input
${type}     id:vectortools_typeList_update
${name}     test update
...
#    type input
    ...
    click element  //*[@id="vectortools_update_input_features"]/div/div/div  #input_features
    input text  id:vectortools_update_input_features_select2_searchInput     ${input_features}
    click element  id:vectortools_update_input_features_select2_resultList_item_0

    click element  //*[@id="vectortools_update_update_features"]/div/div/div  #update_features
    input text  id:vectortools_update_update_features_select2_searchInput     ${update_features}
    click element  id:vectortools_update_update_features_select2_resultList_item_0

# keep borders
    click element  //*[@id="areaBound"]/div/div[3]/div/div/div[1]/div[1]/form/div[4]/div[3]/div/div/div[1]
# default: border
    input text  id:vectortools_update_keep_borders  No\n  #No borders
