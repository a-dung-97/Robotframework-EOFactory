...
${type}     id:ardtools_typeList_vectorization
...
#    type input
    ...
    click element  //*[@id="ardtools_vectorization_rasterResult"]/div/div/div[1]
    input text  id:ardtools_vectorization_rasterResult_imageSelector_searchInput   result_1
