...
#input
${type}     id:ardtools_typeList_pansharpening
...
#    type input
    ...
    input text  id:ardtools_pansharpening_multispectralImage_imageSelector_searchInput   multispectral_image
    click element  id:multispectral_image

    click element  //*[@id="ardtools_pansharpening_panchromaticImage"]/div/div/div[1]
    input text  id:ardtools_pansharpening_panchromaticImage_imageSelector_searchInput    panchromatic_image
    click element  id:panchromatic_image
