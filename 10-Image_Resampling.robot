...
${type}     id:ardtools_typeList_up_scale
...
#    type input
    ...
    click element  //*[@id="ardtools_upscale_image"]/div/div/div[1]
    input text  id:ardtools_upscale_image_imageSelector_searchInput   resampling_image
    click element  id:resampling_image

    input text  id:ardtools_upscale_level   3
