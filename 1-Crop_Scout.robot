...
${type}     id:ardtools_typeList_crop_scout
...
#    type input
    ...
    click element  //*[@id="ardtools_cropScout_rasterResult"]/div/div/div[1]
    input text  id:ardtools_cropScout_rasterResult_imageSelector_searchInput   result_1
