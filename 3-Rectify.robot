...
#input
${type}     id:vectortools_typeList_rectify
${name}     test rectify
${vector}   vector_clip_1
${resolution}   id:vectortools_rectify_resolution
...
#    type input
    ...
    input text  id:vectortools_rectify_vectorResult_select2_searchInput  ${vector}   #vector
    click element  id:vectortools_rectify_vectorResult_select2_resultList_item_0
