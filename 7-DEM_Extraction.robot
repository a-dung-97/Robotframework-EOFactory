...
${type}     id:ardtools_typeList_dem_extraction
...
#    type input
    ...
    click element  //*[@id="ardtools_demExtraction_image"]/div/div/div[1]
    input text  id:ardtools_demExtraction_image_imageSelector_searchInput   dem
