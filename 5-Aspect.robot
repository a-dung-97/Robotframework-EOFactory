*** Settings ***
Documentation  Test Aspect tool.
...
${type}     id:ardtools_typeList_aspect
${name}     aspect_result
...
#    type input
    ...
    click element  //*[@id="ardtools_aspect_image"]/div/div/div[1]
    input text  id:ardtools_aspect_image_imageSelector_searchInput   dem
...
#    select checkbox  id:option_1
    select checkbox  id:option_2
#    select checkbox  id:option_3
#    select checkbox  id:option_4
