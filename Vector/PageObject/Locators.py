class VectorToolkitLocator:
    # type = 'div.vectortools_typeSelector div.v-select__slot'
    type = '#vectorToolkit_typeInput'
    buffer = '#vectortools_typeList_buffer'
    centroid = '#vectortools_typeList_centroid'
    erase = '#vectortools_typeList_erase'
    identity = '#vectortools_typeList_identity'
    intersect = '#vectortools_typeList_intersect'
    rectify = '#vectortools_typeList_rectify'
    row_detection = '#vectortools_typeList_rowDetection'
    simplify = '#vectortools_typeList_simplify'
    symmetrical_difference = '#vectortools_typeList_symmetricalDifference'
    union = '#vectortools_typeList_union'
    update = '#vectortools_typeList_update'
    clip = '#vectortools_typeList_clip'

    name = '#vectortools_nameInput'
    name_error_message = '#vectortools_nameInput div.v-messages__message'
    confirm_button = '#vectortools_confirmButton'
