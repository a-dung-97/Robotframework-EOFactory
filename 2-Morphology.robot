...
${type}     id:ardtools_typeList_morphology
...
#    type input
    ...
    click element  //*[@id="ardtools_morphology_rasterResult"]/div/div/div[1]
    input text  id:ardtools_morphology_rasterResult_imageSelector_searchInput   result_1
